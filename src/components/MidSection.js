    ...
    return (
        <div className='flex mt-7 mx-60 justify-between items-center text-blue-900'>
            <div className='bg-white p-2 rounded-lg w-1/4 h-24'>
                ...
                <p className='text-sm font-normal flex items-center ml-4 mt-2'>Total Rewards <div className='rounded-xl bg-gray-400 text-white w-4 h-4 text-center ml-1 text-xs'>i</div></p>
            </div>
            <div className='bg-white p-2 rounded-lg w-1/4 h-24'>
                <h4 className='text-2xl font-medium ml-4 mt-2'>0.0%</h4>
                <p className='text-sm font-normal flex items-center ml-4 mt-2'>Friends <div className='rounded-xl bg-gray-400 text-white w-4 h-4 text-center ml-1 text-xs'>i</div></p>
            </div>
